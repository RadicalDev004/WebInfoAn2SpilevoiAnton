...
<header>
    <div style="display: flex; align-items: center; gap: 1em;">
        ...
        <button type="button"
            ...
            style="font-size: 2.5em; background: none; border: none; color: {{favorites_selected3}}; cursor: pointer; transform: translateY(0);">
            ▲
        </button>
        <button type="button"
    ...
    <form class="search-bar" id="searchForm" style="display: flex; gap: 0.5em; margin-left: auto;">
        {{back_from_search}}
        <input type="text" id="searchInput" name="query" placeholder="Caută o carte..." style="padding: 0.5em; border: none; border-radius: 5px; color: white;">
    </form>
    ...
    <button type="button"
        ...
        style="width: 36px; height: 36px; font-weight: bold;" class="header-button">⚙
    </button>
</header>
...
function toggleFavorite(button) {
    ...
    .catch(() => button.classList.toggle('selected'));
}
